...
br label %c132
c132:
%ci132 = load i32, i32* %cip
%cp132 = getelementptr i8, i8* %csp, i32 %ci132
%cv132 = load i8, i8* %cp132
%z132 = icmp eq i8 %cv132, 0
br i1 %z132, label %e132, label %b132
b132:
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c133
c133:
%ci133 = load i32, i32* %cip
%cp133 = getelementptr i8, i8* %csp, i32 %ci133
%cv133 = load i8, i8* %cp133
%z133 = icmp eq i8 %cv133, 0
br i1 %z133, label %e133, label %b133
b133:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_i(i8* %csp, i32* %cip)
...
br label %c134
c134:
%ci134 = load i32, i32* %cip
%cp134 = getelementptr i8, i8* %csp, i32 %ci134
%cv134 = load i8, i8* %cp134
%z134 = icmp eq i8 %cv134, 0
br i1 %z134, label %e134, label %b134
b134:
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c135
c135:
%ci135 = load i32, i32* %cip
%cp135 = getelementptr i8, i8* %csp, i32 %ci135
%cv135 = load i8, i8* %cp135
%z135 = icmp eq i8 %cv135, 0
br i1 %z135, label %e135, label %b135
b135:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c136
c136:
%ci136 = load i32, i32* %cip
%cp136 = getelementptr i8, i8* %csp, i32 %ci136
%cv136 = load i8, i8* %cp136
%z136 = icmp eq i8 %cv136, 0
br i1 %z136, label %e136, label %b136
b136:
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c137
c137:
%ci137 = load i32, i32* %cip
%cp137 = getelementptr i8, i8* %csp, i32 %ci137
%cv137 = load i8, i8* %cp137
%z137 = icmp eq i8 %cv137, 0
br i1 %z137, label %e137, label %b137
b137:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c138
c138:
%ci138 = load i32, i32* %cip
%cp138 = getelementptr i8, i8* %csp, i32 %ci138
%cv138 = load i8, i8* %cp138
%z138 = icmp eq i8 %cv138, 0
br i1 %z138, label %e138, label %b138
b138:
call void @bf_d(i8* %csp, i32* %cip)
call void @bf_ii(i32* %cip)
br label %c139
c139:
%ci139 = load i32, i32* %cip
%cp139 = getelementptr i8, i8* %csp, i32 %ci139
%cv139 = load i8, i8* %cp139
%z139 = icmp eq i8 %cv139, 0
br i1 %z139, label %e139, label %b139
b139:
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c140
c140:
%ci140 = load i32, i32* %cip
%cp140 = getelementptr i8, i8* %csp, i32 %ci140
%cv140 = load i8, i8* %cp140
%z140 = icmp eq i8 %cv140, 0
br i1 %z140, label %e140, label %b140
b140:
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c141
c141:
%ci141 = load i32, i32* %cip
%cp141 = getelementptr i8, i8* %csp, i32 %ci141
%cv141 = load i8, i8* %cp141
%z141 = icmp eq i8 %cv141, 0
br i1 %z141, label %e141, label %b141
b141:
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c142
c142:
%ci142 = load i32, i32* %cip
%cp142 = getelementptr i8, i8* %csp, i32 %ci142
%cv142 = load i8, i8* %cp142
%z142 = icmp eq i8 %cv142, 0
br i1 %z142, label %e142, label %b142
b142:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c143
c143:
%ci143 = load i32, i32* %cip
%cp143 = getelementptr i8, i8* %csp, i32 %ci143
%cv143 = load i8, i8* %cp143
%z143 = icmp eq i8 %cv143, 0
br i1 %z143, label %e143, label %b143
b143:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c144
c144:
%ci144 = load i32, i32* %cip
%cp144 = getelementptr i8, i8* %csp, i32 %ci144
%cv144 = load i8, i8* %cp144
%z144 = icmp eq i8 %cv144, 0
br i1 %z144, label %e144, label %b144
b144:
call void @bf_d(i8* %csp, i32* %cip)
br label %c144
e144:
...
br label %c145
c145:
%ci145 = load i32, i32* %cip
%cp145 = getelementptr i8, i8* %csp, i32 %ci145
%cv145 = load i8, i8* %cp145
%z145 = icmp eq i8 %cv145, 0
br i1 %z145, label %e145, label %b145
b145:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c146
c146:
%ci146 = load i32, i32* %cip
%cp146 = getelementptr i8, i8* %csp, i32 %ci146
%cv146 = load i8, i8* %cp146
%z146 = icmp eq i8 %cv146, 0
br i1 %z146, label %e146, label %b146
b146:
call void @bf_put(i8* %csp, i32* %cip)
call void @bf_put(i8* %csp, i32* %cip)
br label %c146
...
br label %c147
c147:
%ci147 = load i32, i32* %cip
%cp147 = getelementptr i8, i8* %csp, i32 %ci147
%cv147 = load i8, i8* %cp147
%z147 = icmp eq i8 %cv147, 0
br i1 %z147, label %e147, label %b147
b147:
call void @bf_d(i8* %csp, i32* %cip)
br label %c148
c148:
%ci148 = load i32, i32* %cip
%cp148 = getelementptr i8, i8* %csp, i32 %ci148
%cv148 = load i8, i8* %cp148
%z148 = icmp eq i8 %cv148, 0
br i1 %z148, label %e148, label %b148
b148:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c149
c149:
%ci149 = load i32, i32* %cip
%cp149 = getelementptr i8, i8* %csp, i32 %ci149
%cv149 = load i8, i8* %cp149
%z149 = icmp eq i8 %cv149, 0
br i1 %z149, label %e149, label %b149
b149:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c150
c150:
%ci150 = load i32, i32* %cip
%cp150 = getelementptr i8, i8* %csp, i32 %ci150
%cv150 = load i8, i8* %cp150
%z150 = icmp eq i8 %cv150, 0
br i1 %z150, label %e150, label %b150
b150:
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
call void @bf_ii(i32* %cip)
...
br label %c151
c151:
%ci151 = load i32, i32* %cip
%cp151 = getelementptr i8, i8* %csp, i32 %ci151
%cv151 = load i8, i8* %cp151
%z151 = icmp eq i8 %cv151, 0
br i1 %z151, label %e151, label %b151
b151:
call void @bf_d(i8* %csp, i32* %cip)
br label %c151
e151:
...
br label %c152
c152:
%ci152 = load i32, i32* %cip
%cp152 = getelementptr i8, i8* %csp, i32 %ci152
%cv152 = load i8, i8* %cp152
%z152 = icmp eq i8 %cv152, 0
br i1 %z152, label %e152, label %b152
b152:
call void @bf_ii(i32* %cip)
call void @bf_i(i8* %csp, i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c153
c153:
%ci153 = load i32, i32* %cip
%cp153 = getelementptr i8, i8* %csp, i32 %ci153
%cv153 = load i8, i8* %cp153
%z153 = icmp eq i8 %cv153, 0
br i1 %z153, label %e153, label %b153
b153:
call void @bf_d(i8* %csp, i32* %cip)
br label %c154
c154:
%ci154 = load i32, i32* %cip
%cp154 = getelementptr i8, i8* %csp, i32 %ci154
%cv154 = load i8, i8* %cp154
%z154 = icmp eq i8 %cv154, 0
br i1 %z154, label %e154, label %b154
b154:
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
call void @bf_di(i32* %cip)
...
br label %c155
c155:
%ci155 = load i32, i32* %cip
%cp155 = getelementptr i8, i8* %csp, i32 %ci155
%cv155 = load i8, i8* %cp155
%z155 = icmp eq i8 %cv155, 0
br i1 %z155, label %e155, label %b155
b155:
call void @bf_d(i8* %csp, i32* %cip)
br label %c155
e155:
...
br label %c156
c156:
%ci156 = load i32, i32* %cip
%cp156 = getelementptr i8, i8* %csp, i32 %ci156
%cv156 = load i8, i8* %cp156
%z156 = icmp eq i8 %cv156, 0
br i1 %z156, label %e156, label %b156
b156:
call void @bf_d(i8* %csp, i32* %cip)
br label %c156
e156:
...
br label %c157
c157:
%ci157 = load i32, i32* %cip
%cp157 = getelementptr i8, i8* %csp, i32 %ci157
%cv157 = load i8, i8* %cp157
%z157 = icmp eq i8 %cv157, 0
br i1 %z157, label %e157, label %b157
b157:
call void @bf_d(i8* %csp, i32* %cip)
br label %c157
e157:
